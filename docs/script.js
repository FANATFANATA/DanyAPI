(function () {
    ...
    var I18N = {
        ru: {
            ...
            qs_install_note: "Скрипт клонирует репозиторий, ставит зависимости, создаёт <code>.env</code>, проверяет токены и запускает сервер. Обновляется сам при каждом старте.",
